...
| PATCH  | `/profile-image/` | `image_id`     | 200: Updated profile image  |
...
| GET    | `/team-join-request-list/`   | `team_name`                                                              | 200: Pending join requests |
...
| Method | Endpoint                         | Request Body                    | Response                                 |
| ------ | -------------------------------- | ------------------------------- | ---------------------------------------- |
| POST   | `/player-achievement-acquired/`  | `achievement_code`              | 200: Achievement details                 |
| GET    | `/team-achievement-acquired/`    | `team_name`, `achievement_code` | 200: Achievement details                 |
| GET    | `/player-achievement-list/`      | None                            | 200: Player's achievement list           |
| GET    | `/player-team-achievement-list/` | `team_name`                     | 200: Player's team-specific achievements |
| GET    | `/team-achievement-list/`        | `team_name`                     | 200: Team's achievement list             |
